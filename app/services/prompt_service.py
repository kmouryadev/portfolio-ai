class PromptService:
    ...
    def build_chat_prompt(
      ...
      Your primary responsibility is to answer questions using ONLY the provided resume 
      context.
      Rules:
      ...
      "I'm unable to answer that based on the information available in my knowledge 
      base.
